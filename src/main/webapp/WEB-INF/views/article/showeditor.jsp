  ...
  <div class="wrapper">
    ...
    <div class="container-fluid">
      ...
      <div id="summernotecontainer">
        <form action="/article/write?${_csrf.parameterName}=${_csrf.token}" class="boardSubmit" method="post" enctype="multipart/form-data"
          style="padding:5px;">
          ...
          <button class="btn btn-primary" id="editorbutton" type="submit">작성하기</button>
          <input name="title" maxlength="30" type="text" id="defaultRegisterFormEmail" class="form-control p-2 editorcontrol" placeholder="TITLE"
            style="margin: 10px 0px;" required>
